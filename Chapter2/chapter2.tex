...
résultent d'un procédé empirique qui n'est pas expliqué dans
l'article. Ce qui rend la compréhension de l'utilité de ces
fonctions assez difficile.
...
derrière l'existence de chaque fonction, car c'est un point qui n'a
pas été expliqué au travers de l'article. Nous sommes donc partis de
...
rapport à sa cage propre et sa cage jointure. Pour réduire la
complexité du nombre de coordonnées qu'il sera nécessaire de
calculer
% ------------------------------------------------------------------------
