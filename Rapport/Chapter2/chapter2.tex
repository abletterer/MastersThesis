  ...
  \begin{center}
    \begin{tikzpicture}
      \begin{axis}[colormap/bluered]
        \addplot gnuplot[scatter, samples=24, domain=0:0.6,
        mark=*]{1/2.*sin(pi*(x/0.6-1/2.))+1/2.};

        \addplot gnuplot[scatter, samples=16, domain=0.6:1,
        mark=*]{1};
    ...
    \begin{tikzpicture}
      \begin{axis}[colormap/bluered]
        \addplot gnuplot[scatter, samples=24, domain=0:0.4,
        mark=*]{1/2.*sin(pi*(x/0.4-1/2.))+1/2.};

        \addplot gnuplot[scatter, samples=24, domain=0.4:1,
        mark=*]{1};
    ...
    \end{tikzpicture} \begin{tikzpicture}
      \begin{axis}[colormap/bluered]
        \addplot gnuplot[scatter, samples=24, domain=0:0.2,
        mark=*]{1/2.*sin(pi*(x/0.2-1/2.))+1/2.};

        \addplot gnuplot[scatter, samples=24, domain=0.2:1,
        mark=*]{1};
      ...
      \end{axis}
    \end{tikzpicture}
    \caption{Visualisation de la fonction f(x)}
    \label{MELfon}
  \end{center}
\end{figure}
