...
cage, qui soit au moins $C^1$ et qui déforme l'espace à la fois à l'intérieur
et à l'extérieur, dans une zone d'influence.
...
la zone d'influence, zone qui délimite la points de l'espace qui seront sous
...
Nous avons décidé de voir les choses d'une autre façon. Déformer l'extérieur de
la cage de contrôle correspond à déformer l'intérieur de la cage d'influence.
