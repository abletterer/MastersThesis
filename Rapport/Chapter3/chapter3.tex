...
\caption[Fonction d'atténuation $d_{inf}(p)$] {Vue en coupe (au centre de la
cage d'influence) de la fonction d'atténuation $d_{inf}(p)$. On remarque que
la fonction n'est pas dérivable au niveau des extrémités de la cage
d'influence.}
...
L'idée vient du travail de \cite{GPCP13}, où ils proposent une fonction pour
