...
Ci-dessous l'algorithme représentant l'étape de déformation avec atténuation: \\
...
Ci-dessous l'algorithme représentant l'étape de déformation avec le mélange
des déformations: \\
