...
\author{\href{mailto:arnaud.bletterer@etu.unistra.fr}{Arnaud
    Bletterer}} \collegeordept{\href{http://mathinfo.unistra.fr/}{UFR
    de Mathématique-Informatique}}
...
% 'UnivShield'
\crest{\includegraphics[scale=0.5, viewport=850 270 0 0]{UnivStrasbourg}}

% insert below the file name that contains the crest in-place of
% 'UnivShield' \crest{\IncludeGraphicsW{UnivShield}{40mm}{14 14 73
% 81}}
%
 \renewcommand{\submittedtext}{Rapport intermédiaire}
%\textmd{}


\degree{Master mention Informatique, \\ Spécialité Informatique et
  Sciences de l'Image} \degreedate{}
