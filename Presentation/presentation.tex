...
\definecolor{MRed}{HTML}{8B0000}
\definecolor{MGreen}{HTML}{008B00}
...
\setbeamercolor{block title example}{use=structure,fg=white,bg=MGreen!75!black}
\setbeamercolor{block body example}{use=structure,fg=black,bg=MGreen!20!white}

\setbeamercolor{block title alert}{use=structure,fg=white,bg=MRed!75!black}
\setbeamercolor{block body alert}{use=structure,fg=black,bg=MRed!20!white}
